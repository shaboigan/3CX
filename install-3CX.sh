...
echo "${Colour}By using this script, you'll remove the default pi account, update the system, install Teamviewer and install the 3CX SBC (Session Border Controller).\nUse CTRL+C to cancel the script\n\n${less}"
